  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['links'] = [
      ...
      '#markup' => '<ul>' .
        ...
        '<li>' . $this->l($this->t('User Profile'), Url::fromRoute('user.page')) . '</li>' .
        ...
        '<li>' . $this->l($this->t('Job Certificates'), Url::fromRoute('surveymanager.job_certificates_form')) . '</li>' .
        '<li>' . $this->l($this->t('Recommendation'), Url::fromRoute('surveymanager.recommendations_form')) . '</li>' .
        '<li>' . $this->l($this->t('Support Document Types'), Url::fromRoute('surveymanager.document_type_form')) . '</li>' .
        '<li>' . $this->l($this->t('Vessels'), Url::fromRoute('surveymanager.vessels_form')) . '</li>' .
